layui.use(["laydate", "table", "util", "form"], function () {
    ...
    table.render({
        ...
        cols: [
            [
                ...
                {field: 'name', title: '角色名', width: 230},
                {field: 'description', title: '角色描述', width: 230},
                {
    ...
    table.on('tool(role)', function (obj) {
        ...
        let data = obj.data;
        if ("edit" === layEvent) {
            window.parent.xadmin.add_tab(data.name, "/admin/role-detail?roleId=" + data.id + "&token=" + localStorage.getItem("token"));
