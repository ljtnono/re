...
public class ReRoleController {
    ...
    public ReJsonResultVO<?> getRoleById(@PathVariable Integer id) {
        ...
        return ReJsonResultVO.success(reRoleService.getRoleById(id));
    }
    ...
    public ReJsonResultVO<?> select() {
        ...
        return ReJsonResultVO.success(reRoleService.select());
    }
    ...
    public ReJsonResultVO<?> addRole(@RequestBody ReRoleDTO reRoleDTO) {
        log.info("[re-system -> ReRoleController -> addRole()] 新增角色，参数：{}", reRoleDTO);
        reRoleService.addRole(reRoleDTO);
    ...
    @GetMapping("/list")
    @PreAuthorize("hasAnyAuthority('system:role:view')")
    public ReJsonResultVO<?> getRoleListPage(ReRoleDTO reRoleDTO) {
        log.info("[re-system -> ReRoleController -> getRoleListPage()] 分页获取角色列表，参数：{}", reRoleDTO);
        return ReJsonResultVO.success(reRoleService.getRoleListPage(reRoleDTO));
    }
    ...
    public ReJsonResultVO<?> logicDeleteById(@PathVariable Integer id) {
        ...
        reRoleService.logicDeleteById(id);
        return ReJsonResultVO.success();
    }
    ...
    public ReJsonResultVO<?> updateRole(@RequestBody ReRoleDTO reRoleDTO) {
        log.info("[re-system -> ReRoleController -> updateRole()] 更新角色，参数：{}", reRoleDTO);
        reRoleService.updateRole(reRoleDTO);
        return ReJsonResultVO.success();
    }
